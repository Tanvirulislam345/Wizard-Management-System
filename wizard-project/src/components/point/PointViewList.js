...
export default function PointViewList({ rows }) {
      ...
      <Table aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">Total Point</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
            ...
            <TableRow key={index}>
              ...
              <StyledTableCell align="center">{row.TotalPoint}</StyledTableCell>
            </TableRow>
          ))}
        </TableBody>
        <TableFooter>
